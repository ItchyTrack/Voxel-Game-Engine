...
use crate::{physics::{self, solver::Solver}, pose::Pose, math::{Mat6, Vec6}};
...
pub struct CollisionConstraint {
	pub collision: physics::collision::Collision,
	friction: f32,
	basis: Mat3,
	c0: Vec3,
	pub penalty: Vec3,
...
impl CollisionConstraint {
	pub fn new(collision: physics::collision::Collision, old_penalty: &Vec3, old_lambda: &Vec3) -> Self {
		Self {
			collision: collision,
			friction: 0.5,
			basis: Mat3::ZERO,
