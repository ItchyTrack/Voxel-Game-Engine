...
pub(crate) const PLANET_RADIUS: Fixed = Fixed::from_bits(512 << 24);
...
pub(super) const TILE_BOUND_PADDING: i32 = CHUNK_SIZE as i32 * 2;
pub(super) const VORONOI_NEIGHBORS: usize = 32;
pub(super) const TERRAIN_HEIGHT: Fixed = Fixed::from_bits(80 << 24);
pub(super) const TILE_SHAPE_EPSILON: Fixed = Fixed::from_bits(16_777);
